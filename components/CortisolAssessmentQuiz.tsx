...
export default function CortisolAssessmentQuiz() {
  ...
  return (
    <section className="w-full bg-[#F5EFE6] border-b border-[#3A3532]/10 py-20 md:py-28" aria-label="Cortisol Diagnostic Quiz">
      <div className="editorial-container max-w-4xl mx-auto flex flex-col gap-10">
        {/* Section Title */}
        ...
        <div
          ref={quizRef}
          className="bg-[#EFE8DC] border border-[#3A3532]/10 p-8 md:p-12 relative shadow-sm min-h-[340px] flex flex-col justify-between"
        >
          {!isCompleted ? (
            <>
              {/* Step indicator */}
