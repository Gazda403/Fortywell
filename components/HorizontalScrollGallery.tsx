...
export default function HorizontalScrollGallery() {
  ...
  useGSAP(() => {
    ...
    if (isMobile) return;
      ...
      // Horizontal scroll transform tween
      ...
      // Card clip-path reveal animations
      cards.forEach((card, i) => {
        if (!card) return;

        const imgMask = imgMasksRef.current[i];

        // Clip-path curtain wipe from right
        gsap.fromTo(
          imgMask,
  ...
  return (
    ...
    >
      <div ref={containerRef} className="w-full h-screen flex flex-col">
        ...
        <div className="flex-1 flex items-center overflow-hidden">
          ...
          >
            {ritualCards.map((card, i) => (
              ...
              >
                {/* Image area with clip-path mask */}
                <div
                  ref={(el) => {
                    if (el) imgMasksRef.current[i] = el;
                  }}
                ...
                >
                  <div
                    className="inner-img absolute inset-0 flex items-center justify-center"
                ...
                <div className="flex flex-col gap-3 p-6 md:p-8 flex-1">
                  ...
                  <h3
                    className="card-text font-editorial text-xl md:text-2xl font-light leading-tight tracking-tight opacity-0"
                    style={{
                      color: i === 0
                        ? '#3A3532'
                        : i === 1
                  ...
                  <p
                    className="card-text text-xs leading-relaxed font-sans font-light opacity-0"
                    style={{
                      color: i === 0
                        ? '#3A353280'
                        : i === 1
                  ...
                  <div
                    className="card-text mt-auto pt-3 border-t opacity-0"
        ...
        <div className="md:hidden flex flex-col gap-6 editorial-container pb-12">
          {ritualCards.map((card, i) => (
            <div
            ...
            >
              ...
              <div className="p-6 flex flex-col gap-3">
                <span className="text-xs tracking-widest uppercase font-sans" style={{ color: card.accent }}>
                  {card.step} · {card.duration}
                </span>
                <h3
                  className="font-editorial text-xl font-light leading-tight"
                ...
                <p
                  ...
                  style={{ color: i === 1 ? '#F5EFE680' : '#3A353280' }}
                >
                  {card.description}
                </p>
              </div>
